...
"../sprites/label.js":56,"../sprites/static.js":57,dragonjs:13}],55:[function(a,b,c){var d=a("dragonjs"),e=a("./label.js");b.exports=d.ClearSprite({name:"drag",solid:!0,depth:10,collisionSets:[d.collisions,a("../collisions/lerp.js")],mask:d.Rectangle(),size:d.Dimension(32,32),pos:d.Point(20,20)}).extend({update:function(){var a;this.dragging?(e.stop(),a=d.Mouse.offset,this.move(d.Point(a.x-this.size.width/2,a.y-this.size.height/2))):(this.speed.x=0,this.speed.y=0,d.Key.arrow.up&&(this.speed.y-=2),d.Key.arrow.right&&(this.speed.x+=2),d.Key.arrow.down&&(this.speed.y+=2),d.Key.arrow.left&&(this.speed.x-=2)),this.base.update()},draw:function(a){a.fillStyle="#b6ff00",a.fillRect(this.pos.x,this.pos.y,this.size.width,this.size.height)}})},{"../collisions/lerp.js":52,"./label.js":56,dragonjs:13}],56:[function(a,b,c){var d=a("dragonjs");b.exports=d.ui.Label({text:"< drag me!",pos:d.Point(60,20),style:function(a){a.font="24px Comic Sans MS",a.textBaseline="top",a.textAlign="left",a.fillStyle="#666"}})},{dragonjs:13}],57:[function(a,b,c){var d=a("dragonjs");b.exports=function(b){return b.pos.subtract(d.Point(-32,-32),!0),d.ClearSprite({name:"static",solid:!0,collisionSets:a("../collisions/lerp.js"),mask:d.Rectangle(),size:d.Dimension(64,64),pos:b.pos}).extend({draw:function(a){a.fillStyle="#444",a.fillRect(this.pos.x,this.pos.y,this.size.width,this.size.height)}})}},{"../collisions/lerp.js":52,dragonjs:13}]},{},[53]);